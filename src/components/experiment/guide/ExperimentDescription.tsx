...
export function ExperimentDescription({ value, onChange }: ExperimentDescriptionProps) {
  return (
    <div className="space-y-4">
      <div>
        <h2 className="text-base font-medium text-gray-900">实验内容</h2>
        <p className="text-sm text-gray-500 mt-1">请描述您的实验目标和主要内容</p>
      </div>
